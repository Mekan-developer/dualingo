                    ...
                    @foreach ($testImages as $testImage)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 text-center text-gray-700 whitespace-nowrap">
                                <img class="w-[75px] h-[75px] object-cover" src="{{$testImage->getCorrectImage()}}" alt="testImage image">
                            </td>
                            <td class="px-4 py-2 text-center text-gray-700 whitespace-nowrap">
                                <img class="w-[75px] h-[75px] object-cover" src="{{$testImage->getIncorrectImage()}}" alt="testImage image">
                            </td>
