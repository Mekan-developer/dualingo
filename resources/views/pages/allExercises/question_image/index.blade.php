                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            @foreach($locales as $locale)
                                <td class="px-4 py-2 text-center text-gray-900 whitespace-nowrap">
                                    {{ $questionImage->getTranslation('translation_correct_words',$locale->locale) }}
                                </td>
                                <td class="px-4 py-2 text-center text-gray-900 whitespace-nowrap">
                                    {{ $questionImage->getTranslation('translation_incorrect_words',$locale->locale) }}
                                </td>
                            @endforeach
                            ...
                            <td class="px-4 py-2 text-center text-gray-700 whitespace-nowrap">
                                <img class="w-[75px] h-[75px] object-cover" src="{{$questionImage->getImage()}}" alt="vocabulary image">
                            </td>
