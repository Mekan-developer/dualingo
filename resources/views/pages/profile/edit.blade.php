...
<div class="bg-white p-8 rounded-sm shadow-lg w-full relative"> 
    <div class="flex justify-end  gap-4">
        <a href="{{ route('download.database') }}">
            <div class="flex items-center gap-1 p-4 active:scale-[0.9] bg-[var(--bg-color-active)] text-white rounded-sm cursor-pointer">
                <span>Backup database</span>
                <i class='bx bxs-download text-[20px]' ></i>
            </div>
        </a>
        <a href="{{ route('download.files') }}">
            <div class="flex items-center gap-1 p-4 active:scale-[0.9] bg-[var(--bg-color-active)] text-white rounded-sm">
