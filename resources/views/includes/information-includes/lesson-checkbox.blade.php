<div class="z-10 bg-white rounded-md shadow w-full ">
    <div class="p-3">
      ...
      <div class="relative">
        ...
        <input type="text" wire:model.live.debounce.500ms="queryLesson" class="bg-gray-50 border border-gray-300 text-[#57BE99] text-sm rounded-lg focus:ring-[#57BE99] focus:border-[#57BE99] block w-full ps-10 p-2.5 " placeholder="Search">
      </div>
    </div>
