      ...
      <li>
        <details class="group [&_summary::-webkit-details-marker]:hidden" {{ Request::is('exercises*') ? 'open' : '' }}>
          ...
          <ul class="px-4 mt-2 space-y-1 text-nowrap ">
            ...
            <li id="listening">
              <a href="{{route('review.index')}}" class="{{ Request::is('exercises/review*') ? 'bg-[var(--bg-color-non-active)]  text-black' : '' }} block rounded-sm px-4 py-2 text-sm font-medium  hover:bg-gray-100 hover:text-gray-700">
                12. Review
                <p class="text-[12px] text-gray-300 -mt-2 ml-4 hover:text-gray-500">review</p>
              </a>
            </li>
