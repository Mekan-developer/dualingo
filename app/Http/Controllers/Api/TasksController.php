...
class TasksController extends Controller
{
     ...
     *      tags={"12.Review, (12.Review)"},
     *      summary="twelfth task of the exercise",
     *      description="двенадцатое задание упражнения, Аудирование",
     *      @OA\Response(response=200,description="review retrived successfully")
     * )
     */

     public function review(){
        $apiData = ReviewResource::collection(Review::where('status',true)->orderBy('order')->get());
        return response()->json($apiData,200);
    }
}
